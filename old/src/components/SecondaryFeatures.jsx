...
const features = [
  {
    name: 'Upload Once',
    description:
      'Your IR team already uploads to SEDAR. Legal Ease pulls automatically, so you only have to upload once.',
  ...
  },
  {
    ...
    description:
      'No more compliance risk for missing disclosure documents on your website. Legal Ease ensures your website is always compliant with all disclosure documents.',
  ...
  },
  {
    ...
    description:
      'Cutting-edge security technology and availability means your website will always load the Legal Ease widget. No downtime.',
    icon: DeviceLockIcon,
  },
  {
